...
-----------------------------
分工：
- 李晉丞：實現PSK in Vivado, 錄製影片, 撰寫期末報告
- 林士軒：實現載波生成in MATLAB, 錄製影片
- 盧翊禎：負責寫網頁, 架網站, 撰寫期末報告(網頁部分)
- 張星瑀：開發Basy 3, 實現UART部分
-----------------------------
...
除了做原本的作業以外，我們組也有將以上資料以網站的方式做架設，由於我們很想要將這個Project成功結合到FPGA開發板上面，所以我們希望可以以網頁的方式來紀錄我們之後所有新增的進度。

那下面會寫說我們網頁的主要功能與程式碼，可以讓各位做參考。
...
---
那以上就是我們的通訊實驗報告，這裡補一個自己的心得好了，首先，老師真的很強，這是長時間累積下來的能力，讓我對老師很欽佩，再來是助教，助教人真的很好，TG有問題問了都會回復，有問題也可以當面立即詢問，因為有些課助教似乎是失蹤，領乾薪的。這個課其實很有趣，因為可以收到看不到東西(radio)，重點是還可以發送。我期中考爆了老師也讓我補考，滿感謝老師的，我不知道可以怎麼回報，我唯一能想到的就是把每一次的報告做到最好，把我所學應用在上面。